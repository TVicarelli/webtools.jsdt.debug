 ...
 * @since 1.0
 */
public class RhinoSecureTransportService extends SocketTransportService {

    /*
     * (non-Javadoc)
     * 
     * @see org.eclipse.wst.jsdt.debug.transport.socket.SocketTransportService#
     ...
     */
    @Override
    public void handleAttach(Connection connection, String username, String password) throws IOException {
    ...
    protected Socket createSocket(String host, int port) throws Exception {
         ...
         */
        String keystoreName = "C:\\Users\\tommaso.vicarelli\\Documents\\keystore.jks"; //$NON-NLS-1$
