...
/**
 * A transport service is used to attach and / or listen to a {@link Connection}
 * . <br>
 * <br>
...
public interface TransportService {
     ...
     * @throws Exception
     */
    public ListenerKey startListening(String address) throws IOException, Exception;
    ...
    /**
     * Listens for a {@link Connection} to be made to and accepts it. The method
     * can block until a {@link Connection} is made.
     * 
     * @param listenerKey
     * @param attachTimeout
    ...
    /**
     * Attaches to the given address and returns the resulting
     * {@link Connection}. This method can block until a {@link Connection} is
     * made
     * 
     * @param address
     * @param attachTimeout
